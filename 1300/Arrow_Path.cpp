...
template <typename T> inline T PointDistance3D(T x1, T y1, T z1, T x2, T y2, T z2) { return sqrt((x2 - x1) * (x2 - x1) + (y2 - y1) * (y2 - y1) + (z2 - z1) * (z2 - z1)); }
template <typename T> inline T Cube(T a) { return a * a * a; }
template <typename T> inline T RectangularPrism(T a, T b, T c) { return a * b * c; }
template <typename T> inline T Pyramid(T base, T height) { return (1.0 / 3) * base * height; }
template <typename T> inline T Ellipsoid(T r1, T r2, T r3) { return (4.0 / 3) * PI * r1 * r2 * r3; }
template <typename T> inline T IrregularPrism(T base, T height) { return base * height; }
template <typename T> inline T Sphere(T radius) { return (4.0 / 3) * PI * radius * radius * radius; }
...
template <typename T> inline T Cone(T radius, T base, T height) { return (1.0 / 3) * PI * radius * radius * height; }
