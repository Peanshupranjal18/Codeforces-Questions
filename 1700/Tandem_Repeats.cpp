...
// lowercase latin letters and or ? mark
// length of longest substring that is tandem repeat is longest possible
// tandem repeat -> first half is equal to second half even length

bool isTandem(intt i, intt j)
